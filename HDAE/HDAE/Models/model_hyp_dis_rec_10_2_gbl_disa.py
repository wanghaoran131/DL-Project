...
class Student_Hyp_DIS_REC(nn.Module):
    ...
    def student_init(self):
        ...
        self.aspect_sds_list = aspects_wds
    ...
    def aspect_intent_sel(self, enc_aspects):
        ...
        return a_dis_emb_tmp, grum_a_probs
    ...
    def forward(self, inputs, batch_num=None):
        ...
        a_dis_emb_tmp, grum_a_probs = self.aspect_intent_sel(enc_aspects)

        # pre_a_probs.view(bsz, self.num_aspects , self.num_seeds, self.dis_mun)
...
# 
        ...
        return eu_r, probs_expanded.squeeze(1), a_probs.squeeze(1), enc,  grum_a_probs
