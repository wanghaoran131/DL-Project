...
# ********************* model select *****************************
if hyper_params['student_type'] in [ 'bert' ]: from Models.model_bert import Student_Bert as Student
...
elif hyper_params['student_type'] in [ 'w2v' ]: from Models.model_w2v import Student_W2V as Student
elif hyper_params['student_type'] in [ 'w2v_tsne' ]: from Models.model_w2v_tsne import Student_W2V as Student


elif hyper_params['student_type'] in [ 'w2v_rec' ]: from Models.model_w2v_rec import Student_W2V_REC as Student
