				...
				for gb_temp in ${gb_temp_bpr[@]}; do
					for hyper_beta in 0.02; do
						for w2v_ratio in 0.1; do
							...
							cmd="python3 ./main.py --sumout ./neva_20_plt/outpt${cur_dt}_dis_mt_gb_plt_2/hyp_dis_rec_mt_10/${DATASET}/${expname}/ \
								...
								--dataset $DATASET --train_type rec_mt_neva_plt --student_type hyper_rec_dis_10_gbl --lr ${lr} \
