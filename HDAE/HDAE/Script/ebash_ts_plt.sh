					...
					for gb_temp in ${gb_temp_bpr[@]}; do
						for hyper_beta in 0.02; do
							for w2v_ratio in 0.1; do
								...
								cmd="python3 ./main.py --sumout ./neva_20_plt/outpt${cur_dt}_ts_w2v_2/ts_w2v/${DATASET}/${expname}/ \
									...
									--dataset $DATASET --train_type ts_only_neva_plt --student_type w2v_rec --lr ${lr} \
