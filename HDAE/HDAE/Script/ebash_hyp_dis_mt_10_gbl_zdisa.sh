					...
					for gb_temp in ${gb_temp_bpr[@]}; do
						for hyper_beta in 0.02; do
							for w2v_ratio in 0.1; do
								...
								cmd="python3 ./main.py --sumout ./neva_24_disa/outpt${cur_dt}_dis_mt_gb_tse_plt_trn/hyp_dis_rec_mt_10/${DATASET}/${expname}/ \
									...
									--dataset $DATASET --aspect_tsne_bt ${tsne_bt} --train_type rec_mt_neva_disen --student_type hyper_rec_dis_10_gbl_disa --lr ${lr} \
