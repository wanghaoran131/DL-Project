...
# for lr in 0.000002 0.0008 0.0001; do
for lr in 0.000002 0.0008 0.0001; do
					...
					for gb_temp in ${gb_temp_bpr[@]}; do
						for hyper_beta in 0.02; do
							for w2v_ratio in 0.1; do
								...
								cmd="python3 ./main.py --sumout ./neva_20_plt/outpt${cur_dt}_w2v_rec_2/w2v_rec/${DATASET}/${expname}/ \
									...
									--dataset $DATASET --train_type rec_only_neva_plt --student_type w2v_rec --lr ${lr} \
