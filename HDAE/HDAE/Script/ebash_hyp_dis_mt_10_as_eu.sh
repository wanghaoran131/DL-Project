...
for lr in 0.0002 0.00002 0.000002; do
				...
				for mt_ratio in ${mt_ratio_bpr[@]}; do
					for hyper_beta in 0.02; do
						for w2v_ratio in 0.1; do
							...
							cmd="python3 ./main.py --sumout ./neva_15/outpt${cur_dt}_dis_mt_as_eu_pmt/hyp_dis_rec_mt_10_as_gbl_eu/${DATASET}/${expname}/ \
								...
								--dataset $DATASET --train_type rec_mt_neva --student_type hyper_rec_dis_10_gbl_as_eu --lr ${lr} \
