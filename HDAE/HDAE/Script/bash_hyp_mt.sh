...
for lr in 0.00000008 0.000000004; do
	for mt_ratio in 100 50 10; do
		expname=mt${mt_ratio}_hyper_lr${lr}
		cmd="python3 ./main.py --sumout ./eva/outpt0417_mt/hyp_rec_mt/${DATASET}/${expname}/ \
			...
			--dataset $DATASET --train_type rec_mt --student_type hyper_rec --lr ${lr} --mt_ratio ${mt_ratio}"
		echo "Executing $cmd"
		$cmd
	done
done