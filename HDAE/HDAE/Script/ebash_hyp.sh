...
for lr in 0.0000004 0.00000004 0.000000004; do
	expname=hyper_lr${lr}
	cmd="python3 ./main.py --sumout ./neva/outpt0418_ts/hyp_ts_only/${DATASET}/${expname}/ \
		...
		--dataset $DATASET --train_type ts_only_neva --student_type hyper --lr ${lr}"
	echo "Executing $cmd"
	$cmd
done
