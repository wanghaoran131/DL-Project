		...
		for dis_2 in 10.0; do
			for dis_3 in 100; do
				for mt_ratio in 100; do
					...
					cmd="python3 ./main.py --sumout ./neva_9/outpt0423_dis_mt/hyp_dis_rec_mt_9/${DATASET}/${expname}/ \
						...
						--dataset $DATASET --train_type rec_mt_neva --student_type hyper_rec_dis_9 --lr ${lr} \
