				...
				for mt_ratio in 100; do
					for hyper_beta in 0.02; do
						for w2v_ratio in 0.1; do
							...
							cmd="python3 ./main.py --sumout ./neva_14/outpt${cur_dt}_dis_mt_as_eu_pd3/hyp_dis_rec_mt_10_as_gbl_eu_30/${DATASET}/${expname}/ \
								...
								--dataset $DATASET --train_type rec_mt_neva --student_type hyper_rec_dis_10_gbl_as_eu_lr --lr ${lr} \
